...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `V8.swiftmodule/`
...
//      `import V8` above would fail at compile time.
//
//   2. The static archive `libV8.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "V8" }` and
//      `flattenPackage = "io.github.kotlinmania.v8"` configuration in
...
final class V8ExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "V8 swift module imported cleanly")
    }
}
