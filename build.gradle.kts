...
kotlin {
    ...
    swiftExport {
        moduleName = "V8"
        flattenPackage = "io.github.kotlinmania.v8"
    }

    android {
        namespace = "io.github.kotlinmania.v8"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "v8-kotlin", version.toString())

    pom {
        name.set("v8-kotlin")
        description.set("Kotlin Multiplatform port of denoland/rusty_v8 - Rust bindings to V8")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/v8-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/v8-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/v8-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/v8-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.v8.codeql
