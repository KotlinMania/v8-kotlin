...
This is a Kotlin Multiplatform line-by-line transliteration port of [`denoland/rusty_v8`](https://github.com/denoland/rusty_v8).

**Original Project:** This port is based on [`denoland/rusty_v8`](https://github.com/denoland/rusty_v8). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `denoland/rusty_v8`

> The text below is reproduced and lightly edited from [`https://github.com/denoland/rusty_v8`](https://github.com/denoland/rusty_v8). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
This Kotlin port is distributed under the same MIT license as the upstream [`denoland/rusty_v8`](https://github.com/denoland/rusty_v8). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the rusty_v8 authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`denoland/rusty_v8`](https://github.com/denoland/rusty_v8) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
