...
This file is the quick-reference operating contract for v8-kotlin. The longer
...
v8-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`v8`](https://crates.io/crates/v8). Upstream Rust is the behavioral oracle while the
